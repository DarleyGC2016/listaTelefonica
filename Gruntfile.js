module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        jshint: {
            ...
            all: [srcDir + '/app/**/contatos/**/*.js', '!' + srcDir + '/**/scripts/livereload.js']
        },
        strip_code: {
            options: {
                blocks: [{
    ...
    grunt.registerTask(
        'build',
        'Compila todos os assets, realiza testes e copia os arquivos para o diretório de build.', ['clean', 'jshint', 'htmllint', 'copy', 'cssmin', 'uglify']
